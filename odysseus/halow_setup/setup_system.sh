...
echo "Enabling serial hardware, disabling serial login console"
raspi-config nonint do_serial 2

# enable spi
echo "Enabling SPI hardware"
...
echo "Blacklisting bt, wifi, custom newracom spidev"
...
echo "Blacklist brcmfmac and brcmutil"
